...
window.addEventListener("load", (event) => {
    ...
    iframe2.src = "https://www.twitch.tv/embed/" + url.substring(8) + "/chat?darkpopout&parent=coldbrewz.github.io"
...
function ChangePage(){
    ...
    if (document.getElementById('ChatCheck').checked) {
        window.location.assign("https://coldbrewz.github.io/SOOP-Watch-Party-Tool/ChatKR.html?twitch=" + channel);
    } else {
